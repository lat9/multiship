...
define('MULTISHIP_CURRENT_VERSION', '1.2.0-beta1');
define('MULTISHIP_UPDATE_DATE', '2017-07-xx');
...
if (!defined('MODULE_MULTISHIP_VERSION')) {
    ...
    $db->Execute(
        "INSERT INTO " . TABLE_CONFIGURATION . " 
            ...
            VALUES 
                ('Multiple-ShipTo Addresses: Version', 'MODULE_MULTISHIP_VERSION', '" . MULTISHIP_CURRENT_VERSION . "', 'The multiship plugin version number', '6', '100', now())"
    );
    $db->Execute(
        "INSERT INTO " . TABLE_CONFIGURATION . " 
                (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) 
            VALUES 
                ('Multiple-ShipTo Addresses: Release Date', 'MODULE_MULTISHIP_RELEASE_DATE', '" . MULTISHIP_UPDATE_DATE . "', 'The multiship plugin release date', '6', '101', now())"
    );
...
if (MODULE_MULTISHIP_VERSION != MULTISHIP_CURRENT_VERSION || MODULE_MULTISHIP_RELEASE_DATE != MULTISHIP_UPDATE_DATE) {
    ...
    $db->Execute(
        "UPDATE " . TABLE_CONFIGURATION . " 
            SET configuration_value = '" . MULTISHIP_UPDATE_DATE . "' 
