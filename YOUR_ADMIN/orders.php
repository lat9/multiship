...
?>
            ...
            <td class="dataTableContent" align="right" valign="top"><strong><?php echo $currencies->format(zen_round($product_price, $currencies->get_decimal_places($currency)) * $product_qty, true, $currency, $currency_value) . ($product_onetime != 0 ? '<br />' . $currencies->format($product_onetime, true, $currency, $currency_value) : ''); ?></strong></td>
...
?>
<?php
//-bof-multiship-lat9   *** 5 of 11 ***
    }  // END non-multiship order processing
//-eof-multiship-lat9   *** 5 of 11 ***
?>
      ...
      <tr>
        <td><table border="0" cellspacing="0" cellpadding="2" class="noprint">
          <tr>
            <td><table border="0" cellspacing="0" cellpadding="2">
<?php
//-bof-multiship-lat9   *** 6 of 11 ***
    if ($order->info['is_multiship_order']) {
        foreach ($order->multiship_info as $multiship_id => $multiship_info) {
?>
              <tr>
                <td class="main"><?php echo sprintf (MULTISHIP_SUBORDER_STATUS, $multiship_info['info']['name']) . zen_draw_pull_down_menu ("multiship_status[$multiship_id]", $orders_statuses, $multiship_info['info']['orders_status']) . zen_draw_hidden_field ("multiship_current_status[$multiship_id]", $multiship_info['info']['orders_status']) . zen_draw_hidden_field ("multiship_shipping_name[$multiship_id]", $multiship_info['info']['name']); ?></td>
              </tr>
<?php
        }
    }
//-eof-multiship-lat9   *** 6 of 11
?>
              <tr>
<?php
//-bof-multiship-lat9   *** 7 of 11 ***
?>
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
<?php
//-bof-multiship-lat9   *** 9 of 11 ***
?>
            <td class="smallText"><?php echo TEXT_LEGEND . ' ' . zen_image(DIR_WS_IMAGES . 'icon_status_red.gif', TEXT_BILLING_SHIPPING_MISMATCH, 10, 10) . ' ' . TEXT_BILLING_SHIPPING_MISMATCH . ' ' . zen_image(DIR_WS_IMAGES . 'icon_status_blue.gif', TEXT_MULTISHIP_ORDER, 10, 10) . ' ' . TEXT_MULTISHIP_ORDER; ?></td>
<?php
//-eof-multiship-lat9   *** 9 of 11 ***
?>
          <tr>
