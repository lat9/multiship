...
?>
            ...
            <td class="dataTableContent" align="right" valign="top"><strong><?php echo $currencies->format($product_price, true, $currency, $currency_value) . ($product_onetime != 0 ? '<br />' . $currencies->format($product_onteimt, true, $currency, $currency_value) : ''); ?></strong></td>
