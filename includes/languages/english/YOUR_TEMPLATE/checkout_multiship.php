...
define('TEXT_RETURN_TO_CONFIRMATION', 'Click here to resume the checkout process');

define('TEXT_CURRENT_SHIPPING_METHOD', 'Your current shipping method: ');
define('TEXT_SHIPPING_METHOD_CHANGE', 'Click here to change your shipping method.');
