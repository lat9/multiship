...
if (!empty($is_multiship_order)) {
    require $template->get_template_dir('tpl_account_history_info_multiship.php', DIR_WS_TEMPLATE, $current_page_base, 'templates') . '/tpl_account_history_info_multiship.php';
    return;
}
