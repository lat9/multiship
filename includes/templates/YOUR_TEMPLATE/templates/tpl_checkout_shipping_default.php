...
if (!empty($offer_multiple_shipping) || !empty($multiple_shipping_active)) {
    require $template->get_template_dir('tpl_checkout_shipping_multiship.php', DIR_WS_TEMPLATE, $current_page_base, 'templates'). '/tpl_checkout_shipping_multiship.php';
} else {
?>
